...
HHN (Happy Home Network) — система автоматизации для TV mounting бизнеса. Обрабатывает звонки и SMS из Zoom Phone, создаёт лиды в Telegram, поддерживает авто-клэйм и роутинг менеджеров.
